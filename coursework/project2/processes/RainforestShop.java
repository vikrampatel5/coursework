...
public class RainforestShop implements Runnable {
    ...
    boolean logout(Transaction transaction) {
        ...
        if(transaction != null && UUID_to_user.containsKey(transaction.getUuid())){
    ...
    public void stopSupplier() {
        ...
        this.supplierStopped(new AtomicBoolean(true));
    }
    ...
    @Override
    public void run() {
        System.out.println("Running Thread for RainforestShop: " + Thread.currentThread().getName());
    }
}
